...
import { SandLock } from "./component";

// The plate drives itself: the sweep runs with no input at all, so the frame
// you land on is either a locked figure or the storm between two of them.
// Everything over it is ordinary DOM type on tokens.
export default function SandLockDemo() {
  return (
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 flex flex-col items-center gap-4 px-6 pb-14 text-center sm:pb-20">
          <div className="flex flex-col items-center gap-3 rounded-lg bg-background/70 px-7 py-5 backdrop-blur-md">
            ...
            <p className="max-w-sm text-sm text-foreground sm:text-base">
              Move across the plate to bend the drive off its resonance, or press to bow it
              until the sand storms.
            </p>
          </div>
          <a
            href="#docs"
