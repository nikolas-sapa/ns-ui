...
import { RingGraze } from "./component";

// The field grows on its own, at a tempo tuned for minutes not seconds;
// everything here is ordinary DOM type on tokens, sitting over it behind a
// scrim so copy stays legible over whatever the field looks like underneath.
export default function RingGrazeDemo() {
  return (
    <main className="h-screen w-full overflow-hidden bg-background">
      <RingGraze>
        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-4 px-6 text-center">
          <div className="flex flex-col items-center gap-3 rounded-lg bg-background/80 px-7 py-6 backdrop-blur-md">
            ...
            <p className="max-w-sm text-sm text-foreground sm:text-base">
              Nothing grew here. Fairy rings graze the field below, dying
              where they meet themselves — or each other.
            </p>
          </div>
          <a
            href="#docs"
