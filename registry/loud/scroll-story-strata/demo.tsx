  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-16 pt-24 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-ns-muted">
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          <a
            href="#core"
            className="rounded-sm bg-foreground px-4 py-2 font-mono text-xs text-background transition-opacity hover:opacity-80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ns-accent"
          >
            start drilling
          </a>
          <a
            href="#field-notes"
            className="rounded-sm border border-border bg-surface px-4 py-2 font-mono text-xs text-ns-muted transition-colors hover:border-foreground/40 hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ns-accent"
          >
            read the survey
          </a>
        </div>
        <p className="mt-10 font-mono text-[10px] uppercase tracking-[0.2em] text-ns-muted">
        ...
        <dl className="mt-10 grid grid-cols-2 gap-px overflow-hidden rounded-md border border-border bg-border sm:grid-cols-4">
          {[
            ...
            <div key={k} className="bg-surface p-4">
              <dt className="font-mono text-[10px] uppercase tracking-[0.2em] text-ns-muted">
                {k}
              </dt>
