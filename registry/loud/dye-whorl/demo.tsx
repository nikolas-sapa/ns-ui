...
import { DyeWhorl } from "./component";

// The tank owns the whole viewport and is already blooming before anything is
// touched. Overlaid type sits on a token scrim, because a plume can pass under
// any line of it and the ink spans most of the value range.
        ...
        <div className="pointer-events-none flex h-full w-full flex-col items-center justify-end gap-4 px-6 pb-14 text-center sm:pb-20">
          <div className="flex flex-col items-center gap-3 rounded-lg bg-background/70 px-7 py-5 backdrop-blur-md">
            ...
            <p className="max-w-sm text-sm text-ns-muted">
              Drag through the tank to stir the plumes, or press to drop a fresh bead.
            </p>
          </div>
          <a
            href="#docs"
