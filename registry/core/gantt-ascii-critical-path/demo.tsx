  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background p-6">
      <div className="flex w-full max-w-3xl flex-col items-center gap-5">
        <p className="self-start font-mono text-[11px] uppercase tracking-[0.18em] text-ns-muted">
        ...
        <p className="max-w-xl text-center text-xs leading-relaxed text-ns-muted">
