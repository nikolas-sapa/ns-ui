        ...
        <DevelopSkeleton loading={loading} blocks={BLOCKS} developMs={950}>
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3.5">
              <div className="grid size-11 shrink-0 place-items-center rounded-full border border-border bg-background font-mono text-xs text-ns-muted">
                NS
              </div>
              <div className="min-w-0">
                <p className="truncate text-sm font-medium text-foreground">Ansel Ward</p>
                <p className="text-xs text-ns-muted">Posted 2 hours ago</p>
              </div>
            </div>

            <div className="grid h-[132px] place-items-center rounded-md border border-border bg-background">
              <span className="font-mono text-[11px] uppercase tracking-[0.18em] text-ns-muted">
                fig. 1 — contact sheet
              </span>
            </div>
