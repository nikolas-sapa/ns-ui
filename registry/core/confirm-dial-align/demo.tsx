...
export default function TumblerGateDemo() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-10 bg-background px-6 py-16">
      <p className="order-1 font-mono text-xs uppercase tracking-[0.2em] text-ns-muted">
      ...
      <button
        ...
        className="order-3 rounded-sm border border-border px-4 py-2 font-mono text-xs text-ns-muted transition-colors duration-150 hover:border-ns-muted hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ns-accent"
      >
        reset
      </button>
      <TumblerGate
