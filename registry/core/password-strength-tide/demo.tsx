...
const inputClass =
  "w-full rounded-sm border border-border bg-surface px-3 py-2 text-sm text-foreground outline-none transition-colors placeholder:text-muted/70 hover:border-foreground/25 focus:border-accent/60 focus:ring-2 focus:ring-accent/30";
    ...
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 px-6 py-16">
      ...
      <div className="w-full max-w-sm rounded-md border border-border bg-surface">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-1 w-full rounded-sm bg-accent px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-accent-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
          >
            Create account
          </button>
