        ...
        {visibleNodes.map((n) => {
          ...
          return (
            <button
              ...
              className="ns-saf-node absolute overflow-hidden border text-left text-[10px] transition-colors duration-150"
              style={{
                left: col * CELL_W,
                top: span.top * CELL_H,
                width: NODE_W * CELL_W,
        ...
        {selectedId ? (
          <span data-sankey-isolated className="inline-flex items-center gap-2">
            ...
            <button
              ...
              className="ns-saf-clear rounded-sm border border-border px-1.5 py-0.5 text-[10px] text-muted transition-colors duration-150 hover:text-foreground"
            >
              Show all
            </button>
          </span>
