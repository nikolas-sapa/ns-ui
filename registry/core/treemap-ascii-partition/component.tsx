    ...
    <div className={`ns-tap font-mono ${className}`}>
      ...
      <div className="mb-2 flex flex-wrap items-center gap-1 text-xs">
        <button
          type="button"
          onClick={() => ascendTo(0)}
          className="ns-tap-crumb rounded-sm px-1.5 py-0.5 text-muted transition-colors duration-150 hover:text-foreground"
        ...
        {path.length > 0 && (
          <button
            ...
            className="ns-tap-crumb ml-2 rounded-sm border border-border px-1.5 py-0.5 text-muted transition-colors duration-150 hover:text-foreground hover:border-accent/40"
          >
            &lt; Up
          </button>
        )}
        ...
        {rects.map((r, i) => {
          ...
          return (
            <button
              ...
              className="ns-tap-rect absolute overflow-hidden border text-left transition-colors duration-150"
              style={{
                left: r.x * CELL_W,
                top: r.y * CELL_H,
                width: r.w * CELL_W,
