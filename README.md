...
Two collections. `core` (<!-- generated:core start -->221<!-- generated:core end -->) is restrained and production-facing, Geist-dark.
`loud` (<!-- generated:loud start -->45<!-- generated:loud end -->) is a deliberately flashy showcase.
