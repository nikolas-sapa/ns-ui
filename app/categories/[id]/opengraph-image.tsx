...
export const alt = "ns-ui category";
...
export default async function Image({
  ...
  const title = copy ? truncate(copy.h1, 90) : "Category not found.";
  const description = copy ? truncate(copy.intro, 150) : undefined;
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {REGISTRY_ORIGIN.replace(/^https?:\/\//, "")}/categories/{category?.id ?? id}
        </div>
      </div>
    ),
    {
