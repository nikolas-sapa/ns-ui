    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 980 }}>
          ...
          >
            What is actually working in ns-ui, measured: ninety days of
            recorded snapshots, and what this repo cannot measure at all.
          </div>
        </div>
        ...
        >
          {REGISTRY_ORIGIN.replace(/^https?:\/\//, "")}/status
        </div>
      </div>
    ),
    {
