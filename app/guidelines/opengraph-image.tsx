...
export const alt = "ns-ui guidelines";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 980 }}>
          ...
          >
            The taste this registry is held to: what counts as one
            interaction, why both themes are non-negotiable, and what gets
            rejected.
          </div>
        </div>
        ...
        >
          {REGISTRY_ORIGIN.replace(/^https?:\/\//, "")}/guidelines
        </div>
      </div>
    ),
    {
