  ...
  return (
    <main className="mx-auto flex max-w-3xl flex-col px-6 py-16 sm:px-10">
      ...
      <section className="mt-10 max-w-2xl border-t border-border pt-8">
        ...
        <p className="mt-2 text-sm leading-6 text-ns-muted">
          Every component is built against five CSS custom properties already
          in scope on the host app —{" "}
          <code className="rounded-sm bg-surface px-1 py-0.5 font-mono text-[13px] text-foreground">
            --background
          </code>
          ,{" "}
          ...
          literal. If your project doesn't define these five properties, an
          installed component won't necessarily error — it may just render
          with the wrong ink, or invisible ink on one theme. Define them
          before installing, not after something looks wrong. Full detail:{" "}
          <Link
            href="/guidelines"
            className="underline underline-offset-2 hover:text-foreground focus-visible:ring-2 focus-visible:ring-ns-accent transition-colors"
          >
        ...
        <ul className="mt-4 flex flex-col gap-3">
          <li className="flex gap-2.5 text-sm leading-6 text-ns-muted">
            ...
            <span>
              ...
              is close to universal: 258 of 266 components respond to it,
              either with a{" "}
              <code className="rounded-sm bg-surface px-1 py-0.5 font-mono text-[13px] text-foreground">
                matchMedia
              </code>{" "}
              ...
              nothing fails a build for the remaining 8.
            </span>
          </li>
          <li className="flex gap-2.5 text-sm leading-6 text-ns-muted">
            <span
            ...
            <span>
              ...
              applies only to the canvas-based components (77 of 266 draw to a
              2D context) — there is no DPR to cap on anything else. Within
              that group it&apos;s the norm but not universal: 75 of 77 cap the
              ratio at 2 before sizing their canvas.
            </span>
          </li>
          <li className="flex gap-2.5 text-sm leading-6 text-ns-muted">
            <span
            ...
            <span>
              ...
              is the weakest of the three: only 47 of 266 components pause
              their render loop when the tab is hidden, and even scoped to
              just the canvas-based components it's a minority behavior (36
              of 79). Don't assume a given animated component stops rendering
