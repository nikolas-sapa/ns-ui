...
export const alt = "ns-ui writing";
...
export default async function Image({
  ...
  const title = post ? truncate(post.title, 90) : "Writing";
  const description = post ? truncate(post.description, 130) : "Post not found.";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {REGISTRY_ORIGIN.replace(/^https?:\/\//, "")}/writing/{slug}
        </div>
      </div>
    ),
    {
