...
export const alt = "ns-ui connect";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 980 }}>
          ...
          >
            Pull the ns-ui registry into an agent: an MCP server, a CLI, and
            the raw llms.txt feeds.
          </div>
        </div>
        ...
        >
          {REGISTRY_ORIGIN.replace(/^https?:\/\//, "")}/connect
        </div>
      </div>
    ),
    {
